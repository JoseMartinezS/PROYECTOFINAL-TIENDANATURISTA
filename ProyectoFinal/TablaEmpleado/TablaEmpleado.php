...
<?php
    ...
    while ($registro = $datos->fetch_assoc())
    {
        ...
        echo "<td class='table-secondary'>".$registro["puesto"]."</td>";
        echo "<td class='table-secondary'>".$registro["sueldo"]."</td>";
        ...
        <form action='EliminarEmpleado.php' method='post' onsubmit=\"return confirm('¿Estás seguro de que deseas eliminar esta compra?')\">
        ...
        <form action='ActualizarEmpleado.php' method='post'>
            <input type='hidden' name='idEmpleado' value='".$registro["idEmpleado"]."'>
            <input class='btn btn-primary' type='submit' name='modificar_".$registro["idEmpleado"]."' value='Modificar'>
        </form>
        </div>
