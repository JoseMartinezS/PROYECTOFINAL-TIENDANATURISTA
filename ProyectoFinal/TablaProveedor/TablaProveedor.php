...
<?php
    ...
    {
        echo "<tr>";
        //echo "<td class='table-secondary'>".$registro["idProveedor"]."</td>";
        ...
        echo "<td class='table-secondary'>".$registro["cantidad_compra"]."</td>";
        ...
        <form action='EliminarProveedor.php' method='post' onsubmit=\"return confirm('¿Estás seguro de que deseas eliminar esta compra?')\">
