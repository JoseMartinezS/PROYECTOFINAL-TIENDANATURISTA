        ...
        <div class="card rounded-3">
          ...
          <div class="card-body p-4 p-md-5">
            ...
            <form action="InsertarDatos.php" method="post">
              ...
              <div class="form-outline mb-4">
                <input type="text" name="tipoPago" id="form3Example1q" class="form-control" />
                <label class="form-label" for="form3Example1q">Tipo de Pago</label>
              </div>

              <div class="form-outline mb-4">
                <input type="text" name="descuento" id="form3Example1q" class="form-control" />
