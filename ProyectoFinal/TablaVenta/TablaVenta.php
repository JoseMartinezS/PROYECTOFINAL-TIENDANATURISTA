...
<?php
    ...
    while ($registro = $datos->fetch_assoc())
    {
        ...
        echo "<td class='table-secondary'>".$registro["tipoPago"]."</td>";
        echo "<td class='table-secondary'>".$registro["descuento"]."</td>";
        //echo "<td class='table-secondary'>".$registro["estatus"]."</td>";
        echo "<td class='table-secondary'>

        <div class='button-container'>
        <form action='EliminarVenta.php' method='post' onsubmit=\"return confirm('¿Estás seguro de que deseas eliminar esta compra?')\">
