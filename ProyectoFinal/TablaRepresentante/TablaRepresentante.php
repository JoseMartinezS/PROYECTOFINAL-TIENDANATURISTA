...
<?php
    ...
    echo "
    <th style='display: none;'>idRepresentante</th>
    ...
    {
        echo "<tr>";
        //echo "<td class='table-secondary'>".$registro["idRepresentante"]."</td>";
        ...
        <form action='EliminarRepresentante.php' method='post' onsubmit=\"return confirm('¿Estás seguro de que deseas eliminar esta compra?')\">
        ...
        <form action='ActualizarRepresentante.php' method='post'>
            <input type='hidden' name='idRepresentante' value='".$registro["idRepresentante"]."'>
