            ...
            <div class="col-lg-8 col-xl-6">
                <div class="card rounded-3">
                    <div class="card-body p-4 p-md-5">
                        <h3 class="mb-4 pb-2 pb-md-0 mb-md-5 px-md-2">Actualizar Representante</h3>
                        <?php
                        ...
                        if ($resultado->num_rows > 0) {
                            ...
                            // Mostrar el formulario con los datos del Representante
                            ...
                            echo '<p>No se encontraron datos para el Representante seleccionado.</p>';
                        }
